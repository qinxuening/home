...
class Page {
    ...
    public function show() {
        ...
        if($nowCoolPage == 1){
            ...
            $prePage    =   "<a href='".str_replace('__PAGE__',$preRow,$url)."' >".L('Pr').$this->rollPage.L('Page')."</a>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage   =   "<a href='".str_replace('__PAGE__',$nextRow,$url)."' >".L('Ne').$this->rollPage.L('Page')."</a>";
